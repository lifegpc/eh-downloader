...
import * as $12 from "./routes/api/status.ts";
import * as $13 from "./routes/api/task.ts";
import * as $14 from "./routes/api/thumbnail/[id].ts";
...
const manifest = {
    routes: {
        ...
        "./routes/api/status.ts": $12,
        "./routes/api/task.ts": $13,
        "./routes/api/thumbnail/[id].ts": $14,
        "./routes/index.tsx": $15,
    },
    islands: {
